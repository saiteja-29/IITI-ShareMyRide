...
<body class="hold-transition login-page" style="background-image:url('https://t4.ftcdn.net/jpg/02/32/92/55/240_F_232925587_st4gM8b3TJHtjjddCIUNyVyFJmZqMmn4.jpg');">
  <script>
    start_loader()
  </script>
  <style>
...
<?php $page = isset($_GET['page']) ? $_GET['page'] : 'home';  ?>
    ...
    <?php endif;?>
  <!-- /.login-logo -->
  <center><img src="<?= validate_image($_settings->info('logo')) ?>" width="100" alt="System Logo" id="logo-img"></center>
